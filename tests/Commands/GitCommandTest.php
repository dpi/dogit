...
/**
 * @coversDefaultClass \dogit\Commands\GitCommand
 */
final class GitCommandTest extends TestCase
{
    ...
    public function testCommand(): void
    {
        ...
        // For \dogit\Listeners\GitCommand\ValidateLocalRepository\IsGit::__invoke
        ...
        $repo->expects($this->any())
            ->method('execute')
            ->withConsecutive(
                // For \dogit\Listeners\GitCommand\ValidateLocalRepository\IsClean::__invoke
                ['status', '--porcelain'],
                // For \dogit\Listeners\GitCommand\GitBranch\GitBranch::__invoke
        ...
        $command = $this->getMockBuilder(GitCommand::class)
            ->onlyMethods(['git'])
        ...
        $result = $tester->execute(
            [
                GitCommandOptions::ARGUMENT_ISSUE_ID => '11110000',
                GitCommandOptions::ARGUMENT_WORKING_DIRECTORY => $testRepoDir,
            ],
            [
                'interactive' => false,
